...
<br/>[Test part]<br/>(https://github.com/niceguyhere/Smart-Implant-Project/blob/master/README2.md)<br/>
<br/>The hardware component of the entire project is nearly complete, with only the wireless charging coil and circuit board remaining to be finalised. All other hardware designs have been completed.
